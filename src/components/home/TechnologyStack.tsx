...
const TECHNOLOGY_ITEMS: TechnologyItem[] = [
  {
    ...
    image: "/assets/technology/solar-panel.jpg",
    alt: "Solar panel",
  },
  {
    id: "02",
    ...
    image: "/assets/technology/inverter.jpg",
    alt: "Solar inverter",
  },
  {
    id: "03",
    ...
    image: "/assets/technology/battery.jpg",
    alt: "Solar battery",
  },
  {
    id: "04",
    ...
    icon: "◎",
    role: "Safety + Delivery",
    description:
      "Protects, connects and distributes electrical power throughout the system.",
    image: "/assets/technology/protection-distribution.jpg",
    alt: "Protection and distribution equipment",
  },
];

export default function TechnologyStack() {
  return (
    <section className="technologyStack" id="technology-stack">
      ...
      <div className="technologyStackInner">
        <div className="technologyStackHeader">
          <div>
            ...
            <h2>
              ...
              <br />
              <span>your solar system.</span>
            </h2>
          </div>

          <div className="technologyStackHeaderCopy">
            <p>
              A complete solar energy system works through several
              technologies working together from generation to safe
        ...
        <div className="technologyStackFlow">
          {TECHNOLOGY_ITEMS.map((item, index) => (
            ...
            >
              ...
              {index < TECHNOLOGY_ITEMS.length - 1 && (
        ...
        <div className="technologySystemPath">
          <small>COMPLETE SYSTEM PATH</small>
        ...
        <div className="technologyStackFooter">
          <div>
            <small>WANT TO GO DEEPER?</small>
            <strong>
              Explore products or use Desh Solar&apos;s
              engineering tools.
            </strong>
          </div>
